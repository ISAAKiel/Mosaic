---
title       : Workshop
subtitle    : Basic Spatial Statistics
...
**ArkeoGIS**
 ...
 1. Select Area of Interesst
 2. Select Data Bases
 3. Select further parameters
 4. Export Results as csv. Table

*** =right

**Use R Studio**

5. Start with a fresh R Script
6. Load data
...
> - Explore your `Data Frame`: Are all values correctly?
> - Is you `Data Frame` to big?! 
> - Crate a `Spatial Points Data Frame`
> - Check your CRS and change projection if necessary
> - ...
...
> - Plot your Data 
> - Use an DEM to visualise the environment
> - Execute a KDE to explore site dentity
> - ...
